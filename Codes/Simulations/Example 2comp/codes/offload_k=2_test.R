...
source("C:/Users/u17056145/Documents/Codes/em_utils copy.R")
source("C:/Users/u17056145/Documents/Codes/NNEM/Example2/estep.R")
...
for(n in sample_sizes) {
  ...
  for(c_rate in censoring_rates) {
    ...
    offload <- foreach(
      ...
      # Load JLCMM results
      wkdir_jlcmm <- paste0("~/Codes/k=2_Results_n=", n, "_c", c_str)
      file_jlcmm <- paste0(wkdir_jlcmm, "/jlcmm_fit", iter, n, ".RData")
      
      # Load NNEM results  
      wkdir_nnem <- paste0("~/Codes/k=2_Results_n=", n, "_c", c_str)
